...
<ion-page>
  <ion-content fullscreen="true">
    <HeaderBar :globalShare="globalShare"></HeaderBar>
          ...
          <div class="w-full">
            <div class="flex flex-row mt-2 py-3">
              ...
              <div class="flex flex-col mb-2 ml-4 mt-1">
                <div class="text-gray-600 text-sm font-semibold">{{ state.article.extra__writer }}</div>
                <div class="flex w-full mt-1">
                  <router-link :to="'list?boardId' + state.article.boardId" class="text-blue-700 font-base text-xs mr-1 cursor-pointer">
                    {{ state.article.boardId == 1 ? "공지" : "자유" }}
                  </router-link>
